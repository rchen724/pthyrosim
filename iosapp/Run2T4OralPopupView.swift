...
struct Run2T4OralPopupView: View {
    ...
    @AppStorage("Run2T4OralDoseInput") private var T4OralDoseInput = ""
    @AppStorage("Run2T4OralDoseStart") private var T4OralDoseStart = ""
    @AppStorage("Run2T4OralDoseEnd") private var T4OralDoseEnd  = ""
    @AppStorage("Run2T4OralDoseInterval") private var T4OralDoseInterval = ""
    ...
    var body: some View {
        ZStack{
            NavigationView {
                ...
                .navigationTitle("Add T4 Oral Dose (Run 2)")
