...
    var onSave: (T3InfusionDose)-> Void
    ...
    init(doseToEdit: T3InfusionDose? = nil, onSave: @escaping (T3InfusionDose)-> Void) {
        ...
        if let dose = doseToEdit {
            _T3InfusionDoseInput = AppStorage(wrappedValue: String(format: "%.1f", dose.T3InfusionDoseInput), "T3InfusionDoseInput")
            _T3InfusionDoseStart = AppStorage(wrappedValue: String(format: "%.1f", dose.T3InfusionDoseStart), "T3InfusionDoseStart")
            _T3InfusionDoseEnd = AppStorage(wrappedValue: String(format: "%.1f", dose.T3InfusionDoseEnd), "T3InfusionDoseEnd")
        }
    }
    
    var body: some View {
