...
    
        @State private var T3IVDoseInput: String = ""
        @State private var T3IVDoseStart: String = ""
        
...
                T3IVDoseInput = String(format: "%.1f", dose.T3IVDoseInput)
                T3IVDoseStart = String(format: "%.1f", dose.T3IVDoseStart)
            }
        }
