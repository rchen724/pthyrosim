...
struct Run3T4InfusionPopupView: View {
    @Environment(\.dismiss) var dismiss
    
    @AppStorage("Run3T4InfusionDoseInput") private var T4InfusionDoseInput = ""
    @AppStorage("Run3T4InfusionDoseStart") private var T4InfusionDoseStart = ""
    @AppStorage("Run3T4InfusionDoseEnd") private var T4InfusionDoseEnd = ""
    ...
    var body: some View {
        ZStack{
            NavigationView {
                ...
                .navigationTitle("Add T4 Infusion Dose (Run 3)")
