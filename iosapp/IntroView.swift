...
struct DescriptionPopupView: View {
    ...
    var body: some View {
        ZStack(alignment: .topTrailing) {
            ...
            VStack {
                    Text("p-THYROSIM is a personalized tool for simulating and visualizing the dynamics of human thyroid hormone (TH) regulation under normal and hypothyroid conditions. It was developed and well-validated from real normal and hypothyroid human data [Ref 1]. It accepts an individual's hormone, gender, weight and height data, as well as hormone dosing options, and provides graphs of their simulated hormone dynamic responses, for euthyroid and hypothyroid conditions, over periods up to 100 days. Users simulate common thyroid system maladies by adjusting TH secretion and/or absorption rates and simulation intervals on the interface (2nd icon at bottom). For simulating patients receiving replacement hormones, remaining icon choices provide several and/or multiple oral input dosing options. Intravenous bolus and/or infusion inputs can also be chosen, for exploratory research and teaching demonstrations. For easy comparisons, the interface includes facility for superimposing up to 4 sets of simulation results. \n\nImportantly, p-THYROSIM is not for self-medication, and not a substitute for professional medical advice. By offering a user-friendly interface, it enables users to gain insights into complex thyroid hormone interactions with remarkable precision. Whether for academic learning or clinical teaching, the tool serves as a gateway to unraveling the intricacies of thyroid physiology. Furthermore, its ability to simulate personalized responses to varied conditions makes it a valuable tool for advancing both education and exploratory research as well as clinical applications.")
                        .font(.custom("About", size: 16))
                        .foregroundColor(.white)
