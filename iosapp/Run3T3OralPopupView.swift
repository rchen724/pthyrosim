...
struct Run3T3OralPopupView: View {
    ...
    @AppStorage("Run3T3OralDoseInput") private var T3OralDoseInput = ""
    @AppStorage("Run3T3OralDoseStart") private var T3OralDoseStart = ""
    @AppStorage("Run3T3OralDoseEnd") private var T3OralDoseEnd  = ""
    @AppStorage("Run3T3OralDoseInterval") private var T3OralDoseInterval = ""
    ...
    var body: some View {
        ZStack{
            NavigationView {
                ...
                .navigationTitle("Add T3 Oral Dose (Run 3)")
