...
struct Run3T4IVPopupView: View {
    @Environment(\.dismiss) var dismiss
    
    @AppStorage("Run3T4IVDoseInput") private var T4IVDoseInput = ""
    @AppStorage("Run3T4IVDoseStart") private var T4IVDoseStart = ""
    ...
    var body: some View {
        ZStack{
            NavigationView {
                ...
                .navigationTitle("Add T4 IV Dose (Run 3)")
