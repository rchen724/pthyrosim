...
struct Run2T3IVPopupView: View {
    @Environment(\.dismiss) var dismiss
    
    @AppStorage("Run2T3IVDoseInput") private var T3IVDoseInput = ""
    @AppStorage("Run2T3IVDoseStart") private var T3IVDoseStart = ""
    ...
    var body: some View {
        ZStack{
            NavigationView {
                ...
                .navigationTitle("Add T3 IV Dose (Run 2)")
